...
const slides: LifestyleSlide[] = [
  { loc: '台東縣', name: '第四屆東岸鋪食節（TTPush）', year: '2024', img: img('taitung-ttpush.png'), href: '/work/dongan-food-festival' },
  { loc: '花蓮縣', name: '「數位有購力．振興拚經濟」記者會', year: '2024', img: img('hualien-digital.png') },
